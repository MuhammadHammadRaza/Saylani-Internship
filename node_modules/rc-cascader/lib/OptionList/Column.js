...
function Column(_ref) {
  ...
  return /*#__PURE__*/React.createElement("ul", {
    ...
    var disabled = option.disabled,
        value = option.value,
        node = option.node;
    var isMergedLeaf = (0, _util.isLeaf)(option);
